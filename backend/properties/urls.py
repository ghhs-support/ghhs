...
urlpatterns = [
    ...
    path('<int:property_id>/update/', views.update_property, name='update_property'),
    path('<int:property_id>/delete/', views.delete_property, name='delete_property'),
    path('<int:property_id>/tenants/', views.add_tenant_to_property, name='add_tenant_to_property'),
