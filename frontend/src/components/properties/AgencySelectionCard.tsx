  ...
  return (
    <div className="border border-blue-200 dark:border-blue-700 rounded-lg p-4 bg-blue-50 dark:bg-blue-900/20">
      ...
      {selectedAgency && (
        <div className="mt-4">
          <div className="flex items-center justify-between mb-2">
            <Label className="text-sm font-medium text-blue-900 dark:text-blue-200">Property Managers</Label>
          ...
          <div className="space-y-2">
            {selectedAgency.property_managers?.map((manager: PropertyManager) => (
              ...
              <div className="text-blue-600 dark:text-blue-400 text-sm py-2 text-center">
