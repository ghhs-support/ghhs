...
const ModalHeader: FC<ModalHeaderProps> = ({ children, onClose, showCloseButton = true, className = "" }) => (
  <div className={`sticky top-0 z-10 flex items-center justify-between px-6 py-5 bg-white dark:bg-gray-900 rounded-t-3xl border-b border-gray-200 dark:border-gray-700 ${className}`}>
...
export const Modal: FC<ModalProps> & { Body: typeof ModalBody; Footer: typeof ModalFooter; Header: typeof ModalHeader } = ({
  isOpen,
  onClose,
  children,
  className,
